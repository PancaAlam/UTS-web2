                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi Barang
                                    </span></a>
                                <ul class="collapse">
                                                ...
                                                <!-- The Modal -->
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <!-- Modal body -->
                                                            <div class="modal-body">
                                                            Apakah Anda yakin ingin menghapus barang ini dari daftar barang?
                                                            <input type="hidden" name="idbrg" value="<?=$idb;?>">
                                                            </div>
